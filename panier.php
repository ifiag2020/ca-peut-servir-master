  ...
  <body>
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item" href="panier.php"
                  >Panier<span style="margin-left: 10px;"
    ...
    <div id="panier">
      <div class="container">
        ...
        <h1>Panier {combien d'articles}</h1>
        <div class="card-panier">
          ...
          <div class="row">
            ...
            <div class="col-md-3 infos">
              ...
              <a href=""
                ><span><i class="fa fa-heart"></i>Ajouter aux favoris</span></a
              >
              <!-- delete du panier-->
              <a href=""
                ><span><i class="fa fa-trash"></i>supprimer</span></a
              >
            </div>
            <!-- //  -->
            <div class="col-md-2 quantity">
              ...
              <select name="number" id="quantity-select">
            ...
            <div class="col-md-3 price">
              <!-- prix de l'unité -->
              <span class="prix-unitaire">{60Dhs}</span>
              <strike>120Dhs</strike>
              <p>Economie: 50%</p>
            </div>
