      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <form accept="" method="POST" class="shadow border p-3">
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="select">Catégorie repas</label>
                  <select id="select" class="form-control form-control-md p-4">
                    <option>...</option>
                  </select>
                </div>
                <div class="form-group col-md-6">
                  <label for="libelle">Libellé</label>
                  <input type="text" class="form-control p-4" id="libelle" />
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="file" class="form-control-file p-2" id="image" />
                </div>
              </div>
