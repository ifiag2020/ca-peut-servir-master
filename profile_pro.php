						 ...
						 <input type="hidden" name="form_user" value="update_user"/>
                          <div class="form-row">
                            <div class="form-group col-md-6">
                              <input type="text" name="nom_commerce" value="<?= $u->nom_commerce ?>" class="form-control p-4"  placeholder="Nom de votre commerce"/>
                            </div>
                            <div class="form-group col-md-6">
                              <input type="text" name="specialite" value="<?= $u->specialite ?>" class="form-control p-4" placeholder="Specialite"/>
                            </div>
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-6">
